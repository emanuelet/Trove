...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference updatePref = findPreference(getString(R.string.update_lib_pref));
            ...
            if (pref != null) {
                ...
                pref.setSummary(year + ". " + getString(R.string.app_name) + " version " + Utility.getAppVersionName(getActivity().getApplicationContext()));
            }
        }
