...
// Get the JSON object representing the day
            ...
            dbValues.put(WeatherEntry.COLUMN_TROVE_KEY, id);
            dbValues.put(WeatherEntry.COLUMN_BOOK_AUTHOR, author);
            dbValues.put(WeatherEntry.COLUMN_BOOK_TITLE, title);
            dbValues.put(WeatherEntry.COLUMN_URL, url);
            dbValues.put(WeatherEntry.COLUMN_BOOK_YEAR, year);
            dbValues.put(WeatherEntry.COLUMN_BOOK_HOLDINGS, holdings);
            dbValues.put(WeatherEntry.COLUMN_BOOK_VERSIONS, versions);
